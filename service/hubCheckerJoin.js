 ...
 */
export function hubChecker(member) {
    ...
    if (userInHub) {
        ...
        inviteChannel.createInvite({ unique: true })
            .then(invite => {
                ...
                member.send(`Ваше личное приглашение https://discord.gg/` + invite + ` действительно 24 часа.`)
            });
        ...
        logHubChannel.send(`@Game Admin || ${member} был кикнут с серверов за отсутствие в хабе ||`);
    }
}